					...
					yes : function() {
						...
						$.ajax({
							...
							success : function(data) {
								...
								var target_item = "<div id='target_" + data.tid + "' style='display:none;' class='target_in'>" + "<div class='target_in_dec'></div>" + "<div>"
										+ "<span>" + data.msg + "</span><br>" + "<font>" + data.score + "</font>" + "</div>"
										+ "<img class='delete_button' src='../img/delete.png' width='25px;' t_id='" + data.tid + "'>" + "</div>";
