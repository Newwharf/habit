					...
					yes : function() {
						...
						$.ajax({
							...
							success : function(data) {
								...
								var target_item = "<div style='display:none;' class='target_item'><div class='line_space'>" + "<div class='line_space_line'></div>" + "</div>"
										+ "<p>" + "<span>" + data.msg + "</span><br>" + "<font>" + data.score + "</font>" + "</p></div>";
